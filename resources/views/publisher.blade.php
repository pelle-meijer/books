...
<div class="panel-body">
        ...
        <form action="/publisher" method="POST" class="form-horizontal">
            {{ csrf_field() }}

            <!-- book name -->
            <div class="form-group">
                <h2><label for="publisher" class="col-sm-3 control-label">New Publisher</label></h2>

                <div class="col-sm-6">
                    <label for="publisher name">name</label>
                    <input type="text" name="name" id="publisher-name" class="form-control">
                </div>
            </div>
